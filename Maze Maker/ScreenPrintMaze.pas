...
function PrinterPixels(ScreenPixels: Integer): Integer;
begin
  Result := ScreenPixels * Printer.XDPI div Screen.PixelsPerInch;
end;
...
begin
  ...
  GetDeviceCaps(Printer.XDPI , VERTRES);
  GetDeviceCaps(Printer.YDPI , HORZRES);
  LabelXPixels.Caption := IntToStr( Printer.XDPI );
  LabelYPixels.Caption := IntToStr( Printer.YDPI );


  //LabelXPixels.Caption := IntToStr( GetDeviceCaps(Printer.XDPI , VERTRES) );
  //LabelYPixels.Caption := IntToStr( GetDeviceCaps(Printer.YDPI , HORZRES) );
end;

procedure TFormPrintMaze.BitBtnCancelClick(Sender: TObject);
begin
...
begin
  ...
  TRY
    ...
    DrawMaze(Printer.Canvas,
             ...
             Seed,
             FormMazeMaker.CheckBoxShowPath.Checked = False,
             PathStyle,
             PathColor,
