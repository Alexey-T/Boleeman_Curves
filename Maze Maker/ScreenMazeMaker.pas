...
uses
  ...
  StdCtrls, Menus, ExtCtrls, Spin, ExtDlgs, Buttons, PrintersDlgs;
...
type
  ...
  TFormMazeMaker = class(TForm)
    ...
    procedure BitBtn_printtwopagesClick(Sender: TObject);
    procedure ButtonNewMazeClick(Sender: TObject);
    procedure CheckBoxShowPathChange(Sender: TObject);
...
BEGIN
  ...
  TRY
    ...
    TRY
      ...
      LabelLength.Caption := 'Length of path = ' + IntToStr(PathLength)
...
procedure TFormMazeMaker.BitBtn_printtwopagesClick(Sender: TObject);
begin

end;

procedure TFormMazeMaker.CheckBoxShowPathChange(Sender: TObject);
begin
    UpdateMaze
end;
...
FormPrintMaze.ShowModal;
  ...
  THEN
  //ModalResult := mrOK;
  ShowMessage('The maze was successfully printed.');
